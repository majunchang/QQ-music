<template>
  <div>
    <div class="singerBg"></div>
    <div class="singerInfo">
      <div class="singer_tag">
        <div class="tagletter">
          <span
            :class="[{'choose':chooseLetter==item},'letter']"
        ...
        <div class="tag_condition">
          <span class="choose letter">全部</span>
          <span class="letter">内地</span>
          <span class="letter">韩国</span>
        </div>
        <div class="tag_condition">
          <span class="choose letter">全部</span>
          <span class="letter">男</span>
          <span class="letter">女</span>
        </div>
        <div class="tag_condition">
          <span class="choose letter">全部</span>
          <span class="letter">流行</span>
          <span class="letter">重低音</span>
        </div>
      </div>
